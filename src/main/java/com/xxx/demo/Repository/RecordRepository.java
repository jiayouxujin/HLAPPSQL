...
public interface RecordRepository extends JpaRepository<Record,Integer> {
    ...
    @Query(value = "SELECT * from record where recordtime between lowerbound=?1 and upperbound=?2 order by recordtime",nativeQuery = true)
    ...
    public void addRecord(String devicenum, String devicetype, String devicestatus, String recordtime);
